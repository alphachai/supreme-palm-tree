...
async def get_order_status():
    status = {s.value: s.name for s in schemas.Status}
...
#     fields = {"order_id": pizza.order_id}
...
## Below this line: not implemented

# @app.get("/pizzas/sizes")
# def get_sizes():
#     return {}
#
#
# @app.get("/pizzas/crusts")
# def get_crusts():
#     return {}
#
#
# @app.get("/pizzas/cheeses")
# def get_cheeses():
#     return {}
